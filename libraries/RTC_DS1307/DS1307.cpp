...
PROGMEM const prog_char DS1307::NameOfDay[]=
"Sun\0Mon\0Tue\0Wed\0Thu\0Fri\0Sat\0";
PROGMEM const prog_char DS1307::NameOfMonth[]=
...
void DS1307::stop(void)
{
    ...
    uint8_t r = readRegister((uint8_t) DS1307_SEC);
	r |= DS1307_CLOCKHALT;
    writeRegister(DS1307_SEC, r);
}
...
void DS1307::start(void)
{
    ...
    uint8_t r = readRegister(DS1307_SEC);
    if ( r & DS1307_CLOCKHALT )
    	writeRegister(DS1307_SEC, r & ~DS1307_CLOCKHALT);
}
